      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-7xl mx-auto">
            <div className="bg-gradient-to-br from-white/90 to-blue-50/90 dark:bg-gray-800/80 backdrop-blur-md rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-3 sm:p-6 transform hover:scale-[1.01] sm:hover:scale-[1.02] transition-all duration-300 border border-blue-200/30 col-span-1 sm:col-span-2">
              <div className="relative">
                ...
                <div className="flex items-center justify-center gap-1.5 sm:gap-2 mb-4 sm:mb-6 relative">
                  <span className="text-lg sm:text-2xl flex-shrink-0">📦</span> 
                  <p className="text-xs sm:text-lg font-medium bg-gradient-to-r from-blue-800 to-purple-800 dark:text-gray-300 text-transparent bg-clip-text">
                    packed with care - fees may vary
                  </p>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-6 relative">
                  <a
                    href="tel:+94720317155"
                    className="flex items-center justify-center gap-2 sm:gap-3 p-2.5 sm:p-4 bg-gradient-to-r from-blue-100/80 to-purple-100/80 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-lg sm:rounded-xl hover:from-blue-200/80 hover:to-purple-200/80 dark:hover:from-emerald-800/30 dark:hover:to-teal-800/30 transition-all duration-300 group border border-blue-200/30 shadow hover:shadow-md transform hover:-translate-y-0.5 sm:hover:-translate-y-1"
                  >
                    <span className="text-lg sm:text-2xl transform group-hover:scale-110 transition-transform flex-shrink-0">📱</span>
                    <span className="text-xs sm:text-lg font-medium text-gray-900 dark:text-white">+94 72 031 7155</span>
                  </a>
                  <a
                  ...
                  >
                    <span className="text-lg sm:text-2xl transform group-hover:scale-110 transition-transform flex-shrink-0">📷</span>
                    <span className="text-xs sm:text-lg font-medium text-gray-900 dark:text-white break-words">@shen_qalam_calligraphy</span>
                  </a>
                </div>
              </div>
            </div>
